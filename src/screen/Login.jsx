            ...
            <div className="login-pages">
                <div className="center">
                    <div className="header">
                        ...
                        <div className={`reset-pass ${status === 2 ? 'active' : ''}`}><button onClick={() => setStatus(2)}>RESET PASS</button></div>
                    </div>
                    <div className="body">
                        ...
                        <div className="input-group">
                            <i className='bx bxs-low-vision' onClick={() => setShow(!show)}></i>
                            <input type={show ? 'text' : 'password'} placeholder='Password' name='password' value={account.password} onChange={e => handleChange(e)} />
                        </div>
                        {
                            status === 1 ? '' :
                                <div className="input-group">
